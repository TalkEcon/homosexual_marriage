...
pic_3
ggsave("graph3.jpg", width=8, height=4.5)
ggsave("graph3.svg", width=8, height=4.5)

# graph 4-1
graph_4 <- read.csv("graph_4.csv")
...
pic_4_1
ggsave("graph4_1.jpg", width=8, height=4.5)
ggsave("graph4_1.svg", width=8, height=4.5)
...
pic_4_2
ggsave("graph4_2.jpg", width=8, height=4.5)
ggsave("graph4_2.svg", width=8, height=4.5)
